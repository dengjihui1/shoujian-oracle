...
本项目 0.10.0 不是完整“巡宅”的复制品，而是经明确边界筛选后的独立教学组件。
...
0.9.0 放开卦后普通对话，只有真正追问本卦时才强绑定卦象证据；同时完善危机支持、上下文恢复与发布质量基线。

0.10.0 将生意、投资、医疗、法律、感情、长期命运和多问题统一改为“允许起卦并附参考说明”，只有即时人身危险停止起卦；界面不再展示供应商传输说明，TTS 长句阈值降至 72 字，并为流式中途断线增加完整回答恢复协议。
