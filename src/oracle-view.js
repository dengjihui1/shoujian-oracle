...
const styles = `<style>
  ...
  * { box-sizing: border-box; } button, textarea { font: inherit; }
  ...
  [data-avatar-state="speaking"] .avatar-speaking { animation: mouth-talk .24s steps(2,end) infinite; }
  ...
  .voice-meter { height: 22px; display: flex; gap: 3px; align-items: end; margin-top: 8px; } .voice-meter i { flex: 1; height: 3px; max-height: 20px; background: linear-gradient(#dcb26f,#7d3429); border-radius: 4px; opacity: .25; }
  [data-avatar-state="listening"] .voice-meter i,[data-avatar-state="speaking"] .voice-meter i { opacity: .8; animation: meter .7s calc(var(--bar) * -70ms) ease-in-out infinite alternate; }
  ...
  @keyframes cursor-blink { 50% { opacity: 0; } } @keyframes halo-turn { to { rotate:360deg; } } @keyframes breathe { 50% { transform: translateY(-3px) scale(1.006); } } @keyframes mouth-talk { 0%,100% { opacity:.05 } 50% { opacity:1 } } @keyframes pulse { 50% { opacity:.38; box-shadow:0 0 0 8px currentColor; } } @keyframes meter { to { height: var(--amp); } }
  ...
  @media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important;animation:none!important}[data-avatar-state="speaking"] .avatar-speaking{opacity:.72}}
</style>`;
