...
当前自动化、真实云端链路和浏览器人工验收结果见 [0.27.0 历史质量基线](QUALITY_BASELINE.md)、[0.28.0 全方位评估](ASSESSMENT_2026-09-23.md)与 [0.29.0 后续自检](SELF_ITERATION_2026-09-23.md)。语音队列只在播放器触发开声事件后进入 `playing`；服务端根据六爻重算卦象；卦后普通聊天不再强塞旧卦和原问。
