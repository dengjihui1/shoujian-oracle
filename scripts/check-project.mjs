...
const required = [
  "README.md", "NOTICE.md", "LICENSE", "index.html", "package-lock.json", "Dockerfile", ".dockerignore", ".env.production.example", "deploy/Caddyfile", "deploy/compose.yml", "deploy/compose.env.example", "playwright.config.js", "e2e/oracle-flow.spec.js", "docs/COMPONENT_MAP.md", "docs/LEARNING_GUIDE.md", "docs/MODULE_POOL.md", "docs/QUALITY_BASELINE.md", "docs/DEPLOYMENT.md", "docs/DEVICE_ACCEPTANCE.md", "docs/VIRTUAL_HUMAN_RESEARCH.md", "docs/OPTIMIZATION_RESEARCH.md", "docs/VOICE_RAG_ARCHITECTURE.md", "docs/CACTUS_MODULE_EXTRACTION.md", "docs/USER_FEEDBACK_BACKLOG.md",
