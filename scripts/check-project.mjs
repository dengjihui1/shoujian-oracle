...
const required = [
  "README.md", "NOTICE.md", "LICENSE", "index.html", "docs/COMPONENT_MAP.md", "docs/LEARNING_GUIDE.md", "docs/MODULE_POOL.md", "docs/QUALITY_BASELINE.md", "docs/VIRTUAL_HUMAN_RESEARCH.md", "docs/OPTIMIZATION_RESEARCH.md", "docs/VOICE_RAG_ARCHITECTURE.md",
  "docs/API_SETUP.md", "server/index.mjs", "server/gemini-client.mjs", "server/prompt.mjs",
  "server/knowledge-retriever.mjs", "server/rate-limiter.mjs", "server/cloud-client.mjs", "server/openai-compatible-client.mjs", "server/speech-cache.mjs", "knowledge/shoujian-rag.v1.json", "knowledge/README.md", "evaluation/rag-cases.json", "scripts/evaluate-rag.mjs",
